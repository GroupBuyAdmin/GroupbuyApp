...
public class ClientNavBar extends JPanel{
    ...
    public String getSearchedItem(){
        return searchBar.getSearchField().getText();
    }
    ...
    public class SearchBar extends RoundedPanel{
        ...
        public SearchBar(){
            ...
            this.searchButton = new JButton(new ImageIcon("src/groupbuyapp/Client/ClientCenter/ClientNavBar/img/search.png"));
    ...
    public class Profile extends JPanel{
        ...
        private static String defaultProfile = "src/groupbuyapp/Client/ClientCenter/ClientNavBar/img/default profile2.png";
        private static String signOutIcon = "src/groupbuyapp/Client/ClientCenter/ClientNavBar/img/sign out.png";
