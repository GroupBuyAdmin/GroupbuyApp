package groupbuyapp.NewClient.ClientSidebar;
...
public class ClientSidebar extends JPanel{
    ...
    public class LogoContainer extends JPanel{  
        ...
        private static final ImageIcon gbuyLogo = new ImageIcon("src/groupbuyapp/NewClient/ClientSidebar/img/gbuy vector sidebar.png");
    ...
    public class ClientButtons extends JPanel{
        ...
        private static ImageIcon homeIcon = new ImageIcon("src/groupbuyapp/NewClient/ClientSidebar/img/home.png");
        private static ImageIcon myListingsIcon = new ImageIcon("src/groupbuyapp/NewClient/ClientSidebar/img/my listings.png");
        private static ImageIcon myGroupbuysIcon = new ImageIcon("src/groupbuyapp/NewClient/ClientSidebar/img/my groupbuys.png");
        private static ImageIcon browseGroupbuysIcon = new ImageIcon("src/groupbuyapp/NewClient/ClientSidebar/img/browse groupbuys.png");
        
        private static ImageIcon homeIconAlt = new ImageIcon("src/groupbuyapp/NewClient/ClientSidebar/img/home alt.png");
        private static ImageIcon myListingsIconAlt  = new ImageIcon("src/groupbuyapp/NewClient/ClientSidebar/img/my listings alt.png");
        private static ImageIcon myGroupbuysIconAlt  = new ImageIcon("src/groupbuyapp/NewClient/ClientSidebar/img/my groupbuys alt.png");
        private static ImageIcon browseGroupbuysIconAlt  = new ImageIcon("src/groupbuyapp/NewClient/ClientSidebar/img/browse groupbuys alt.png");
